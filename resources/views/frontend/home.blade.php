    ...
    <div class="swiper mySwiper banner-slide">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <img src="{{asset('frontend/assets/css/images/grocery.webp')}}" class="" alt="">
        </div>
        <div class="swiper-slide">
          <img src="{{asset('frontend/assets/css/images/grocery.webp')}}" class="" alt="">
        </div>
        ...
        <div class="card-body">
          ...
          {{-- <div class="single-cart-container">
            ...
            <div class="cart-product-image mx-4">
              <img src="{{ asset('frontend/assets/images/products/Apples.webp')}}" alt="">
            </div>
            <div>
          ...
          <div class="text-center" style="margin: 50% auto;">
            <svg width="140" height="176" viewBox="0 0 231.91 292">
              ...
              <g id="no_cart_in_bag_2" data-name="no cart in bag 2" transform="translate(-1388 -351)">
                <ellipse id="Ellipse_2873" data-name="Ellipse 2873" cx="115.955" cy="27.366" rx="115.955" ry="27.366"
                  transform="translate(1388 588.268)" fill="#ddd" opacity="0.25"></ellipse>
        ...
        <div class="card rounded-0">
          <div class="card-body">
            <div class="swiper mySwiper categories-slide">
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  <img src="{{ asset('frontend/assets/images/categories/1.jpg')}}" class="w-100 rounded" alt="">
                </div>
                <div class="swiper-slide">
                  <img src="{{ asset('frontend/assets/images/categories/2.jpg')}}" class="w-100 rounded" alt="">
                </div>
                <div class="swiper-slide">
                  <img src="{{ asset('frontend/assets/images/categories/1.jpg')}}" class="w-100 rounded" alt="">
                </div>
    ...
    <div class="row h-100">
      <div class="col-xl-2 bg-white p-0">
        <div class="categories-list-group mt-4">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20.347 24.101" fill="currentColor"
                ...
                <g id="Grocery" transform="translate(-39.481 0.052)">
                  ...
                  <path id="Path_17387" data-name="Path 17387"
                    ...
                    transform="translate(-0.5)" fill="currentColor" stroke="currentColor" stroke-width="0.1">
                  </path>
                </g>
              </svg>
              ...
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20.59 25.05" fill="currentColor"
                ...
                <g id="home_cleaner" data-name="home cleaner" transform="translate(-2142.193 -787.635)">
                  <path id="Path_17440" data-name="Path 17440"
                    ...
                    transform="translate(-39.669 -37.554)" fill="none" stroke="currentColor" stroke-linecap="round"
                  ...
                  <path id="Path_17441" data-name="Path 17441"
                    ...
                    transform="translate(-138.167 -70.32)" fill="none" stroke="currentColor" stroke-linecap="round"
                    stroke-linejoin="round" stroke-width="0.9"></path>
                  <path id="Path_17442" data-name="Path 17442"
                    ...
                    transform="translate(-79.113 -103.39)" fill="none" stroke="currentColor" stroke-linecap="round"
                    stroke-linejoin="round" stroke-width="0.9"></path>
                  <path id="Path_17443" data-name="Path 17443" d="M2156.93,1189.207"
                    transform="translate(-13.516 -380.522)" fill="none" stroke="currentColor" stroke-linecap="round"
                    stroke-linejoin="round" stroke-width="0.9"></path>
                  <path id="Path_17444" data-name="Path 17444" d="M2320.353,830.622h1.328v1.584h-1.328"
                    transform="translate(-168.605 -40.225)" fill="none" stroke="currentColor" stroke-linecap="round"
                    stroke-linejoin="round" stroke-width="0.9"></path>
                  <path id="Path_17445" data-name="Path 17445"
                    ...
                    transform="translate(0 -129.588)" fill="none" stroke="currentColor" stroke-linecap="round"
                    stroke-linejoin="round" stroke-width="0.9"></path>
                  <path id="Path_17446" data-name="Path 17446"
                    ...
                    transform="translate(-129.259 -130.762)" fill="none" stroke="currentColor" stroke-linecap="round"
                    stroke-linejoin="round" stroke-width="0.9"></path>
                  <line id="Line_15" data-name="Line 15" y1="1.511" x2="3.16" transform="translate(2154.628 788.235)"
                    fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="0.9">
                  </line>
                  <line id="Line_16" data-name="Line 16" x2="3.16" y2="1.511" transform="translate(2154.628 792.632)"
                    fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="0.9">
                  </line>
                  <line id="Line_17" data-name="Line 17" x2="4.259" transform="translate(2154.628 791.189)" fill="none"
                    stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="0.9"></line>
                  ...
                  <path id="Path_17447" data-name="Path 17447"
                    ...
                    transform="translate(-228.757 -159.112)" fill="none" stroke="currentColor" stroke-linecap="round"
                    stroke-linejoin="round" stroke-width="0.9"></path>
              ...
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16.967 22.1" fill="currentColor"
                ...
                <g id="Dairy" transform="translate(-71.95 -15.95)">
                  <path id="Path_17395" data-name="Path 17395"
                    ...
                    transform="translate(0 0)" fill="currentColor" stroke="currentColor" stroke-width="0.1"></path>
                ...
                <g id="Cooking" transform="translate(-61.55 -195.55)">
                  <g id="Group_12320" data-name="Group 12320" transform="translate(62 196)">
                    <g id="Group_12319" data-name="Group 12319" transform="translate(11.006 10.518)">
                      <line id="Line_10" data-name="Line 10" x2="0.963" fill="none" stroke="currentColor"
                        stroke-linejoin="round" stroke-width="0.9">
                      </line>
                      <line id="Line_11" data-name="Line 11" x2="0.963" transform="translate(2.345)" fill="none"
                        stroke="currentColor" stroke-linejoin="round" stroke-width="0.9"></line>
                      <line id="Line_12" data-name="Line 12" x2="0.963" transform="translate(4.691)" fill="none"
                        stroke="currentColor" stroke-linejoin="round" stroke-width="0.9"></line>
                    </g>
                    <path id="Path_17428" data-name="Path 17428" d="M578.074,414.485l3.192-.59v-1.15h-3.192Z"
                      transform="translate(-553.266 -406.978)" fill="none" stroke="currentColor" stroke-linejoin="round"
                      stroke-width="0.9"></path>
                    <path id="Path_17429" data-name="Path 17429" d="M506.668,414.485l-3.192-.59v-1.15h3.192Z"
                      transform="translate(-503.476 -406.978)" fill="none" stroke="currentColor" stroke-linejoin="round"
                      stroke-width="0.9"></path>
                    <path id="Path_17430" data-name="Path 17430"
                      ...
                      transform="translate(-509.882 -399.805)" fill="none" stroke="currentColor" stroke-linejoin="round"
                      stroke-width="0.9"></path>
                    <line id="Line_13" data-name="Line 13" y1="1.939" transform="translate(13.941)" fill="none"
                      stroke="currentColor" stroke-miterlimit="10" stroke-width="0.9">
                    </line>
                    <line id="Line_14" data-name="Line 14" x2="3.606" transform="translate(12.197)" fill="none"
                      stroke="currentColor" stroke-miterlimit="10" stroke-width="0.9">
                    </line>
                    <path id="Path_17431" data-name="Path 17431"
                      ...
                      transform="translate(-509.882 -406.911)" fill="none" stroke="currentColor" stroke-linejoin="round"
                      stroke-width="0.9"></path>
                  </g>
                </g>
              </svg>
              ...
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 25.408 18.5" fill="currentColor"
                ...
                <g id="Breakfast" transform="translate(0.25 -70.75)">
                  <path id="Path_17388" data-name="Path 17388"
                    ...
                    transform="translate(-229.276 -57.081)" fill="currentColor" stroke="#fff" stroke-width="0.4">
                  </path>
                  <path id="Path_17389" data-name="Path 17389"
                    d="M292.335,131.324a.73.73,0,1,0-1.214.81l.973,1.459a.73.73,0,0,0,1.214-.81Z"
                    transform="translate(-276.841 -57.08)" fill="currentColor" stroke="#fff" stroke-width="0.4">
                  </path>
                  <path id="Path_17390" data-name="Path 17390"
                    ...
                    transform="translate(-162.679 -57.08)" fill="currentColor" stroke="#fff" stroke-width="0.4">
                  </path>
          ...
          <div>
            <button class="category-dropdown">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14.569 26.099" class="categories-icon-size">
                <path id="bevarage"
                  ...
                  transform="translate(-895.457 -373.443)" fill="currentColor" stroke="#fff" stroke-width="0.1">
                </path>
              </svg>
      ...
      <div class="col-xl-10" style="background-color: #F3F4F6;">
        <div class="m-4">
          <div class="row">
            <div class="col-6 col-md-4 col-lg-3 col-xl-3 col-xxl-2dot4 p-0">
              <div class="card mb-2 mx-1">
                ...
                <div class="single-product-card">
                  <a href="product-detail.html" class="text-decoration-none">
                    <img src="{{ asset('frontend/assets/images/products/Apples.webp') }}" class="" alt="">
                  </a>
                </div>
            ...
            <div class="col-6 col-md-4 col-lg-3 col-xl-3 col-xxl-2dot4 p-0">
              <div class="card mb-2 mx-1">
                <div class="single-product-card">
                  <a href="product-detail.html" class="text-decoration-none">
                    <img src="{{ asset('frontend/assets/images/products/BabySpinach.webp') }}" class="" alt="">
                  </a>
                </div>
                <div class="single-product-detail">
                  <div class="mb-2 single-product-amount">
            ...
            <div class="col-6 col-md-4 col-lg-3 col-xl-3 col-xxl-2dot4 p-0">
              <div class="card mb-2 mx-1">
                <div class="single-product-card">
                  <a href="product-detail.html" class="text-decoration-none">
                    <img src="{{ asset('frontend/assets/images/products/blueberries.webp') }}" class="" alt="">
                  </a>
                </div>
                <div class="single-product-detail">
                  <div class="mb-2 single-product-amount">
            ...
            <div class="col-6 col-md-4 col-lg-3 col-xl-3 col-xxl-2dot4 p-0">
              <div class="card mb-2 mx-1">
                <div class="single-product-card">
                  <a href="product-detail.html" class="text-decoration-none">
                    <img src="{{ asset('frontend/assets/images/products/BrusselsSprouts.webp') }}" class="" alt="">
                  </a>
                </div>
                <div class="single-product-detail">
                  <div class="mb-2 single-product-amount">
            ...
            <div class="col-6 col-md-4 col-lg-3 col-xl-3 col-xxl-2dot4 p-0">
              <div class="card mb-2 mx-1">
                <div class="single-product-card">
                  <a href="product-detail.html" class="text-decoration-none">
                    <img src="{{ asset('frontend/assets/images/products/clementines.webp') }}" class="" alt="">
                  </a>
                </div>
                <div class="single-product-detail">
                  <div class="mb-2 single-product-amount">
            ...
            <div class="col-6 col-md-4 col-lg-3 col-xl-3 col-xxl-2dot4 p-0">
              <div class="card mb-2 mx-1">
                <div class="single-product-card">
                  <a href="product-detail.html" class="text-decoration-none">
                    <img src="{{ asset('frontend/assets/images/products/Corn.webp') }}" class="" alt="">
                  </a>
                </div>
                <div class="single-product-detail">
                  <div class="mb-2 single-product-amount">
            ...
            <div class="col-6 col-md-4 col-lg-3 col-xl-3 col-xxl-2dot4 p-0">
              <div class="card mb-2 mx-1">
                <div class="single-product-card">
                  <a href="product-detail.html" class="text-decoration-none">
                    <img src="{{ asset('frontend/assets/images/products/Cucumber.webp') }}" class="" alt="">
                  </a>
                </div>
                <div class="single-product-detail">
                  <div class="mb-2 single-product-amount">
            ...
            <div class="col-6 col-md-4 col-lg-3 col-xl-3 col-xxl-2dot4 p-0">
              <div class="card mb-2 mx-1">
                <div class="single-product-card">
                  <a href="product-detail.html" class="text-decoration-none">
                    <img src="{{ asset('frontend/assets/images/products/Dates.webp') }}" class="" alt="">
                  </a>
                </div>
                <div class="single-product-detail">
                  <div class="mb-2 single-product-amount">
            ...
            <div class="col-6 col-md-4 col-lg-3 col-xl-3 col-xxl-2dot4 p-0">
              <div class="card mb-2 mx-1">
                <div class="single-product-card">
                  <a href="product-detail.html" class="text-decoration-none">
                    <img src="{{ asset('frontend/assets/images/products/FrenchGreenBeans.webp') }}" class="" alt="">
                  </a>
                </div>
                <div class="single-product-detail">
                  <div class="mb-2 single-product-amount">
            ...
            <div class="col-6 col-md-4 col-lg-3 col-xl-3 col-xxl-2dot4 p-0">
              <div class="card mb-2 mx-1">
                <div class="single-product-card">
                  <a href="product-detail.html" class="text-decoration-none">
                    <img src="{{ asset('frontend/assets/images/products/GreenBeans.webp') }}" class="" alt="">
                  </a>
                </div>
                <div class="single-product-detail">
                  <div class="mb-2 single-product-amount">
